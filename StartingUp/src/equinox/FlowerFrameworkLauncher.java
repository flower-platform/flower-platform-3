...
//		String policyFile = context.getRealPath(POLICY_FILE);
        //todo
		String policyFile = "D:\\data\\java_work\\eclipse_workspace_flowerPlatform\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\org.flowerplatform.web.app\\WEB-INF\\all.policy";
		                    //context.getRealPath(POLICY_FILE);
...
//	 * @see web.xml file for parameter documentation
	...
	protected Map buildInitialPropertyMap() {
        ...
        //todo
		String developmentLaunchConfiguration = "Flower Platform - Idea";//config.getInitParameter(developmentLaunchConfigurationProperty);
		...
		if (developmentLaunchConfiguration != null) {
			// dev mode
            //todo
			developmentWorkspaceRoot = "D:\\data\\java_work\\eclipse_workspace_flowerPlatform\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\org.flowerplatform.web.app\\..\\..\\..\\..\\..\\..";
			//context.getRealPath(WEB_APP_CONTEXT_TO_DEV_WS_PATH);
...
//			String relativeOsgiConfigurationArea = config.getInitParameter("eclipseConfigurationLocation");
            //todo
			String relativeOsgiConfigurationArea = "relativeOsgiConfigurationArea";
			osgiConfigurationArea = "relativeOsgiConfigurationArea"; //context.getRealPath(relativeOsgiConfigurationArea);
...
//		String workspaceLocation = config.getInitParameter("workspaceLocation");
		String workspaceLocation = "../runtime-flower-platform-idea";
...
//		properties.put("flower.server.tmpdir", ((File) context.getAttribute(ServletContext.TEMPDIR)).getAbsolutePath());
    ...
    private Map getProperties() {
        //TODO
        HashMap properies = new HashMap();

        properies.put("/WEB-INF/all.policy","D:\\data\\java_work\\eclipse_workspace_flowerPlatform\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps\\org.flowerplatform.web.app\\WEB-INF\\all.policy");

        properies.put("developmentLaunchConfigurationWindows", "Flower Platform - Idea");
        //properies.put("


        return properies;  //To change body of created methods use File | Settings | File Templates.
    }
