...
public class RenameMoveTest {
	...
	public void renameMoveTest() throws TeamException  {
		...
		// Test 1 => move a folder from the repository to another folder that exists in the repository
		remoteResourcePath = getArrayOfPathFragmentsFromStringArgs(
			    "explorerTreeStatefulService|Explorer1", "r", "hibernate",
			    "organization", ".svn-repositories", "svnRepositories", "svn://csp1/flower2", "svnRepository", "testCreate12", "svnFolder");
		destinationPath = getArrayOfPathFragmentsFromStringArgs(
			    "explorerTreeStatefulService|Explorer1", "r", "hibernate",
			    "organization", ".svn-repositories", "svnRepositories", "svn://csp1/flower2", "svnRepository", "testCreate11", "svnFolder");
		remoteResourceName = "testCreate12";
		comment = "lala";
		actionResult = SvnService.getInstance().renameMove(context, remoteResourcePath, destinationPath, remoteResourceName, comment);
		...
		remoteResourcePath = getArrayOfPathFragmentsFromStringArgs(
			    "explorerTreeStatefulService|Explorer1", "r", "hibernate",
			    "organization", ".svn-repositories", "svnRepositories", "svn://csp1/flower2", "svnRepository", "testCreate11", "svnFolder", "testCreate12", "svnFolder");
		destinationPath = getArrayOfPathFragmentsFromStringArgs(
			    "explorerTreeStatefulService|Explorer1", "r", "hibernate",
		...
		remoteResourcePath = getArrayOfPathFragmentsFromStringArgs(
			    "explorerTreeStatefulService|Explorer1", "r", "hibernate",
			    "organization", ".svn-repositories", "svnRepositories", "svn://csp1/flower2", "svnRepository", "testCreate11", "svnFolder", "testCreate5", "svnFolder");
		destinationPath = getArrayOfPathFragmentsFromStringArgs(
			    "explorerTreeStatefulService|Explorer1", "r", "hibernate",
			    "organization", ".svn-repositories", "svnRepositories", "svn://csp1/flower2", "svnRepository", "testCreate2", "svnFolder");
		...
		// Test 4 => move a folder to a folder that already contains a folder with the same name; it will fail
//		remoteResourcePath = getArrayOfPathFragmentsFromStringArgs(
//			    "explorerTreeStatefulService|Explorer1", "r", "hibernate",
//			    "organization", ".svn-repositories", "svnRepositories", "svn://csp1/flower2", "svnRepository", "testCreate7", "svnFolder");
//		destinationPath = getArrayOfPathFragmentsFromStringArgs(
//			    "explorerTreeStatefulService|Explorer1", "r", "hibernate",
//			    "organization", ".svn-repositories", "svnRepositories", "svn://csp1/flower2", "svnRepository", "testCreate11", "svnFolder");
...
//		assertEquals(true, actionResult);
		...
		// Test 5 => check if the folder is one of the destination's children after the actions
