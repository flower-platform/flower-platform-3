...
public class DelegatingGenericTreeStatefulService2 extends
		GenericTreeStatefulService2 {

	private static Logger logger = LoggerFactory.getLogger(DelegatingGenericTreeStatefulService2.class);
	...
	private Map<String, INodeDataProvider2> nodeDataProviders = new HashMap<String, INodeDataProvider2>();
	...
	public Map<String, INodeDataProvider2> getNodeDataProviders() {
	...
	public boolean populateTreeNode(Object source, TreeNode destination, GenericTreeContext context) {
		...
		INodeDataProvider2 provider = nodeDataProviders.get(nodeType);
		if (provider == null) {
