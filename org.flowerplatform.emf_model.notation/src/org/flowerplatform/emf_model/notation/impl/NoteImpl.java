 ...
 * <ul>
 *   <li>{@link org.flowerplatform.emf_model.notation.impl.NoteImpl#getText <em>Text</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NoteImpl extends NodeImpl implements Note {
	...
	protected EClass eStaticClass() {
		return NotationPackage.Literals.NOTE;
	}
	...
	public void setText(String newText) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, NotationPackage.NOTE__TEXT, oldText, text));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case NotationPackage.NOTE__TEXT:
				return getText();
		}
