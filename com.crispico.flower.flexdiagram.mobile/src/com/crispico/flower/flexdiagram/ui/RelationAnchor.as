package com.crispico.flower.flexdiagram.ui {
	...
	/**
	 * Visual component displaying an arrow icon marking the possibily to drag a relation.
	 * Displayed when a Figure is selected and used by SelectMoveResizeTool to create new 
	 * connections between elements.
	 * 
	 * @author Luiza
	 * @flowerModelElementId _SIV_ADm_EeCd8NTSFM7DsQ
	 */ 
	public class RelationAnchor extends UIComponent {
		...
		/**
		 * Returnes the EditPart attached to the AbstractSelectionAnchors component that holds and positions
		 * this RelationAnchor.
		 */ 
