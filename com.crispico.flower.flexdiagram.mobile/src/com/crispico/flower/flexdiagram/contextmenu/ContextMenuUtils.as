package com.crispico.flower.flexdiagram.contextmenu
{
	...
	public class ContextMenuUtils {
		 ...
		 */ 		
		public static function getStageLocationForContainerUsingLocal(figure:UIComponent, scrollableContainer:Group, localPointOfFigure:Point):Point {
		 ...
		 */ 
		public static function getStageLocationForContainer(scrollableContainer:Group, contentLocation:Point, scaleFactor:Number = 1):Point {
...
//			}
		...
		public static function diagramGetDisplayAreaOfSelection(viewer:DiagramViewer):Rectangle {
			...
			var scrollableContainer:Group = RootFigure(viewer.getRootEditPart().getFigure()); 			
