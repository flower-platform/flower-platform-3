 ...
 * <ul>
 *   <li>{@link org.flowerplatform.web.entity.impl.NamedEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class NamedEntityImpl extends EntityImpl implements NamedEntity {
	...
	protected EClass eStaticClass() {
		return EntityPackage.Literals.NAMED_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EntityPackage.NAMED_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EntityPackage.NAMED_ENTITY__NAME:
				return getName();
		}
