 ...
 */
public class AddNewExtension_BackboneTableView extends AddNewExtension_BackboneView {

	protected Collection<String> getInitializationTypes() {
		return Collections.singleton(JavaScriptDescriptors.INIT_TYPE_BACKBONE_TABLE_VIEW);
	}
