...
public class Match {
	 ...
	 * @author Mariana
	 */
	public CodeSyncEditableResource getEditableResource() {
		Match root = this;
		while (root.getParentMatch() != null) {
			root = root.getParentMatch();
		}
		return root.editableResource;
	}

	/**
	 * @author Mariana
	 */
	public void setEditableResource(CodeSyncEditableResource editableResource) {
