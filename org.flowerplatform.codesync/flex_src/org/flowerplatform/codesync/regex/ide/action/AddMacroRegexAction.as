...
package org.flowerplatform.codesync.regex.ide.action {
	 ...
	 */ 
	public class AddMacroRegexAction extends ActionBase	implements IDialogResultHandler {
		
		public function AddMacroRegexAction() {
		...
		override public function run():void {
			...
			var view:AddMacroRegexView = new AddMacroRegexView();
		...
		public function handleDialogResult(result:Object):void {
			CommunicationPlugin.getInstance().bridge.sendObject(
				new InvokeServiceMethodServerCommand("regexService", "addMacro", 
					[CodeSyncPlugin.getInstance().regexUtils.selectedConfig, result[0], result[1]]));
		}
